declare var l: any;
declare var machineCode: any;
declare function ________________(any): void;
...
declare function justA_into_A(): void;
...
declare function justA_into_B(): void;
declare function cmp(): void;
...
declare function JZFar(any, any): void;
declare function JNZ(any): void;
declare function JNZFar(any, any): void;
declare function JC(any): void;
declare function JCFar(any, any): void;
declare function JNC(any): void;
declare function JNCFar(any, any): void;
declare function JNK(any): void;
declare function JNKFar(any, any): void;
declare function JNKA(any): void;
declare function JNKAFar(any, any): void;
declare function jumpA(): void;
declare function jumpABFar(): void;
declare function keyboardA(): void;
declare function storeKbdInc(): void;
declare function output(any): void;
declare function outputA(): void;
declare function outputB(): void;
declare function lcdCtrl(any): void;
declare function lcdCtrlA(): void;
declare function lcdCtrlB(): void;
declare function BmovA(): void;
declare function AmovB(): void;
declare function BmovC(): void;
declare function AmovC(): void;
declare function CmovA(): void;
declare function CmovB(): void;
...
declare function ABloadA(): void;
declare function ABloadB(): void;
declare function storeTwo(any, any, any, any): void;
...
declare function pushA(): void;
declare function popA(): void;
declare function pushB(): void;
declare function popB(): void;
declare function pushAB(): void;
declare function popAB(): void;
